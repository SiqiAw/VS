            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ url('/insertProduct') }}">{{ __('Insert Product') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ url('/insertCategory') }}">{{ __('Insert Category') }}</a>
                        </li>
                        @guest
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item" href="{{ route('my.order') }}">Payment</a>
